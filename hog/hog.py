...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    ones_digit = score0 % 10
    tens_digit = (score1 - 100 * (score1 // 100)) // 10
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            score0 += take_turn(num_roll0, score1, dice)
            if is_swap(score0, score1):
                score0, score1 = score1, score0
        else:
            num_roll1 = strategy1(score1, score0)
            score1 += take_turn(num_roll1, score0, dice)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def sayBiggestGain(score0, score1):
        # high means the gain points.
        if who == 0:
            scoreGain = score0 - previous_score
            score = score0
        else:
            scoreGain = score1 - previous_score
            score = score1

        if scoreGain > previous_high:
            print(scoreGain, "point(s)! That's the biggest gain yet for Player", who)
            return announce_highest(who, scoreGain, score)
        else:
            return announce_highest(who, previous_high, score)

    return sayBiggestGain
    # END PROBLEM 7
